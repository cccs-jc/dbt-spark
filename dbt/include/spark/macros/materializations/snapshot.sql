...
{% macro spark__snapshot_merge_sql(target, source, insert_cols) -%}
    ...
    {# jcc pyspark create view only supports a name (no catalog, or schema) #}
...
{% macro spark_build_snapshot_staging_table(strategy, sql, target_relation) %}
    ...
    {# TODO: jcc iceberg catalog does not support create view, but regular spark does. We removed the catalog and schema#}                                
